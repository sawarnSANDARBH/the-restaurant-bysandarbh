      ...
      <div>
        <div className="h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm">
         <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white rounded-md duration-200 w-[300px]'>
           ...
           <div className='mt-4'>
            <input type="email" placeholder='Enter Email' className='w-full rounded-md border-gray-300 dark:border-gray-500 px-2 py-1 mb-4 '/>

            <input type="Password" placeholder='Enter Password' className='w-full rounded-md border-gray-300 dark:border-gray-500 px-2 py-1 mb-4 '/>

            <div>
              <button className='w-full bg-primary text-white p-2 rounded-md ' onClick={()=>setShowPopup(false)}>
               Login
              </button>
            </div>
