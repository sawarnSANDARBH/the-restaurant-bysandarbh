       ...
       <div className="container">
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-14 sm:gap-4'>
          <div className='text-center flex justify-center items-center flex-col gap-1 px-2'>
            <p className='text-dark/70 font-semibold '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis.</p>
            <p className='text-5xl rotate-90 text-primary text-center translate-x-5'>....</p>
            <FaBus className='text-5xl text-primary '/>
          </div>
            
            <div className='text-center flex justify-center items-center text-center flex-col gap-1 px-3'>
